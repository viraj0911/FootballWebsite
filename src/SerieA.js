...
export class SerieA extends React.Component {
	state = {
		year: '2022',
	...
	onTermSubmit = async (term) => {
		await fetch(`https://v3.football.api-sports.io/standings?league=135&season=${term}`, {
			method: 'GET',
			headers: {
		...
		await fetch(`https://v3.football.api-sports.io/players/topscorers?season=${term}&league=135`, {
			method: 'GET',
			headers: {
				'x-rapidapi-key': '9926fb7beac5dabf66069e663a5380bc',
				'x-rapidapi-host': 'v3.football.api-sports.io'
