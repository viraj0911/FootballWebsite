...
export class PremierLeague extends React.Component {
	...
	onTermSubmit = async (term) => {
		await fetch(`https://v3.football.api-sports.io/standings?league=39&season=${term}`, {
			method: 'GET',
			headers: {
		...
		await fetch(`https://v3.football.api-sports.io/players/topscorers?season=${term}&league=39`, {
			method: 'GET',
			headers: {
				'x-rapidapi-key': '9926fb7beac5dabf66069e663a5380bc',
				'x-rapidapi-host': 'v3.football.api-sports.io'
	...
	render() {
		return (
			<div className="ui container">
				<YearInput leagueLogo={this.state.flag} league="Premier League" onFormSubmit={this.onTermSubmit} />
