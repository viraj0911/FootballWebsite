...
export class LaLiga extends React.Component {
	state = {
		year: '2022',
	...
	onTermSubmit = async (term) => {
		await fetch(`https://v3.football.api-sports.io/standings?league=140&season=${term}`, {
			method: 'GET',
			headers: {
	...
	render() {
		return (
			<div className="ui container">
				<YearInput leagueLogo={this.state.flag} league="La Liga" onFormSubmit={this.onTermSubmit} />
